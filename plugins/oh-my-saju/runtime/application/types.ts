...
export type OhMySajuCommand = PrepareOhMySajuReadingCommand | ValidateOhMySajuReadingCommand;
...
export type OhMySajuResponse = OhMySajuPreparedSuccess | OhMySajuValidatedSuccess | OhMySajuFailure;
