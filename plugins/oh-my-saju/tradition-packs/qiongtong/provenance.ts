/** Reproducibility and fixture inventory owned by the Qiongtong Pack. */
...
const PACK_DIRECTORY = 'plugins/oh-my-saju/tradition-packs/qiongtong';
const KNOWLEDGE_RESOURCES = [
  'sources.json',
  'rules.json',
  'qiongtong-table-v1.ts',
  'profile.ts',
  'evaluate.ts',
  'fixtures.json',
  'provenance.json',
...
export const QIONGTONG_PROVENANCE: TraditionPackProvenance = deepFreeze({
