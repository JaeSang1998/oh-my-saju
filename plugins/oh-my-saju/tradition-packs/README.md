...
- `ziping@1.0.0`, `ditianshui@1.0.0`, and `qiongtong@1.0.0`: isolated classical doctrine
  candidates/evidence;
- `sanming-symbolic-curated@1.0.0`: only a cited year-branch travel-horse match, complete-chart
  absence, or explicitly partial observation, with no broad 신살, 길흉, movement, travel, or event
  claim.
