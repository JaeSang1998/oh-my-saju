/** Reproducibility and fixture inventory owned by the Ziping Pack. */
...
const PACK_DIRECTORY = 'plugins/oh-my-saju/tradition-packs/ziping';
...
export const ZIPING_PROVENANCE: TraditionPackProvenance = deepFreeze({
