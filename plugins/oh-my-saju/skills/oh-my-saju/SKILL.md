---
name: oh-my-saju
description: Calculate and interpret Korean Saju (Four Pillars) with a deterministic core, explicit 12 growth stages, a narrowly curated raw travel-horse overlay, versioned Tradition Packs, birth-time uncertainty, and finding-referenced Korean narration. Use for 사주·만세력·오행·십신·십이운성·격국 후보·신강신약 근거·조후, unknown or approximate birth time, tradition comparison, decision or timing questions, or auditing an existing Saju reading. Do not use for Western astrology, tarot, broad symbolic-star claims, generic Korean editing, or choices the user does not want viewed through Saju.
license: Apache-2.0
---
...
- `analysis.doctrines`: versioned Tradition Pack results, including only the curated raw
  travel-horse branch match for symbolic stars;
